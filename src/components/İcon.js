...
const Svg = ({ children,className,size}) => {
    return (
...
const XIcon = ({size}) =>{
    return (
        <Svg className="" size={size}>
            <g className='d-flex align-items-center justify-content-center seIcon'>
...
const MainSectionGlobusIcon = ({size}) =>{
    return (
        <Svg className="" size={size}>
            <g className='d-flex align-items-center justify-content-center seIcon'>
...
const MainSectionImgIcon = ({size}) =>{
    return (
        <Svg className="mx-2" size={size}>
            <g className='d-flex align-items-center justify-content-center seIcon'>
...
const MainSectionPollIcon = ({size}) =>{
    return (
        <Svg className="mx-2" size={size}>
            <g className='d-flex align-items-center justify-content-center seIcon'>
...
const MainSectionSmileIcon = ({size}) =>{
    return (
        <Svg className="mx-2" size={size}>
            <g className='d-flex align-items-center justify-content-center seIcon'>
...
const MainSectionAddIcon = ({size}) =>{
    return (
        <Svg className="tFB-icon" size={size}>
            <g><path d="M19.75 11H13V4.25c0-.553-.447-1-1-1s-1 .447-1 1V11H4.25c-.553 0-1 .447-1 1s.447 1 1 1H11v6.75c0 .553.447 1 1 1s1-.447 1-1V13h6.75c.553 0 1-.447 1-1s-.447-1-1-1z"></path></g>
        </Svg>    
    )
}
...
const SettingIcon = ({size}) =>{
    return (
        <Svg className="settingIcon " size={size}>
            <g>
...
export const Icon = ({name ,size = '25'}) => {
	...
	const icons = {
        ...
        logo:Logo,
        dots:DotsIcon,
        search:SearchLupaIcon,
        xicon:XIcon,
        stars:StarsIcon,
        globus:MainSectionGlobusIcon,
        img:MainSectionImgIcon,
        gif:MainSectionGifIcon,
        poll:MainSectionPollIcon,
        smile:MainSectionSmileIcon,
        location:MainSectionLocationIcon,
        calendar:MainSectionCalendarIcon,
        add:MainSectionAddIcon,
        setting:SettingIcon,
	}
